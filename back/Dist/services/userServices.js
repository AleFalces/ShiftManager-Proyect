...
exports.deleteUsersServices = exports.loginUserService = exports.updateUsersServices = exports.createUsersServices = exports.getUserByIServices = exports.getUsersServices = void 0;
const credentialServices_1 = require("./credentialServices");
const userRepository_1 = __importDefault(require("../repositories/userRepository"));
const ITurns_1 = require("../interfaces/ITurns");
const data_source_1 = require("../config/data-source");
let getUsersServices = () => __awaiter(void 0, void 0, void 0, function* () {
    let AllUsers = yield userRepository_1.default.find({
        relations: {
            turns: true,
        },
    });
...
let getUserByIServices = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
let createUsersServices = (userData, userCredential) => __awaiter(void 0, void 0, void 0, function* () {
    const newUser = yield userRepository_1.default.userCreate(userData, userCredential);
    return newUser;
});
exports.createUsersServices = createUsersServices;
let updateUsersServices = (userdata) => __awaiter(void 0, void 0, void 0, function* () {
...
let loginUserService = (userdata) => __awaiter(void 0, void 0, void 0, function* () {
    const userLog = yield data_source_1.CredetialSource.findOne({
    ...
    if (userLog.password !== userdata.password) {
        ...
        const logedUser = yield userRepository_1.default.findOne({
...
let deleteUsersServices = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const turn of userDelete.turns) {
        ...
        yield data_source_1.TurnSource.save(turn);
    }
    yield (0, credentialServices_1.deleteCredentialService)(userDelete.credentials.id);
